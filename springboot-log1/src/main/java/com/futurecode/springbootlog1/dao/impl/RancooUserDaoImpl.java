...
@Repository("roncooUserDao")
public class RancooUserDaoImpl extends JdbcDaoImpl implements RoncooUserDao {
    ...
    public RoncooUser selectById(int id) {
        ...
        return super.queryForObject(sql , RoncooUser.class , id);
    }
    ...
    public Page<RoncooUser> queryForPage(int pageCurrent, int pageSize, String name){
        ...
        return super.queryForPage(sql.toString(), pageCurrent, pageSize, RoncooUser.class);
    }
